  ...
  return (
    <main className={dark ? "app theme-dark" : "app theme-light"}>
      <header className="topbar public-topbar">
        <Link prefetch={false} href="/" className="brand" aria-label="Auction War Room — inicio">
        ...
        <div className="header-actions">
          {backHref && <Link prefetch={false} className="ghost-button" href={backHref}>{backLabel || "← Volver"}</Link>}
          {headerRight}
